...
The following tests were performed to validate the code and demonstrate its metrological capabilities. The first two datasets are included as sample data with the software.
...
## Inflation
Bicycle tube inflated to five different pressures:
